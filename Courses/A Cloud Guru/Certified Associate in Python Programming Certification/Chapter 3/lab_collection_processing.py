...
assert sorted_by_name == [
    ...
    {"name": "Kevin Bacon", "age": 61},
    {"name": "Victor Wong", "age": 74},
], f"Expected 'sorted_by_name' to equal '{[{'name': 'Ariana Richards', 'age': 40}, {'name': 'finn Carter', 'age': 59}, {'name': 'Fred Ward', 'age': 77}, {'name': 'Kevin Bacon', 'age': 61}, {'name': 'Victor Wong', 'age': 74}]}''"
...
name_declarations = list(map(lambda x: x['name'] + " is " + str(x['age']) + " years old", sorted_by_name))
# alternatively:
name_declarations = list(map(lambda x: f"{x['name']} is {str(x['age'])} years old", sorted_by_name))
...
under_seventy = sorted(under_seventy, key=lambda x: x['age'])

assert under_seventy == [
    {"name": "Ariana Richards", "age": 40},
    {"name": "finn Carter", "age": 59},
    {"name": "Kevin Bacon", "age": 61},
], f"Expected 'under_seventy' to equal '{[{'name': 'Ariana Richards', 'age': 40}, {'name': 'finn Carter', 'age': 59}, {'name': 'Kevin Bacon', 'age': 61}]}'"
